...
state=Indonesia
locality=Indonesia
organization=days.project.com
organizationalunit=days.project.com
commonname=days.project.com
email=admin@days.project.com
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Days-Project/Autoscript/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/Days-Project/Autoscript/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/Days-Project/Autoscript/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/Days-Project/Autoscript/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/Days-Project/Autoscript/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
